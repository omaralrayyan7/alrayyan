/* ============================================================================
   ...
   (XSS-safe). Bilingual EN/AR, dark/light theme, live bookings.
   ========================================================================== */
(function () {
  'use strict';
  ...
  var I18N = {
    en: {
      ...
      navDash: 'Dashboard', navBookings: 'Bookings', navAvail: 'Availability', navBiz: 'Businesses',
      kpiPending: 'Pending Bookings', kpiUnits: 'Available Units', kpiTotal: 'Total Bookings',
    ...
    ar: {
      ...
      navDash: 'لوحة التحكم', navBookings: 'الحجوزات', navAvail: 'التوفر', navBiz: 'الأعمال',
      kpiPending: 'حجوزات معلقة', kpiUnits: 'وحدات متاحة', kpiTotal: 'إجمالي الحجوزات',
  ...
  /* ---------- state ------------------------------------------------------- */
  var bookings = [], availability = {}, bizStatus = {}, floorStatus = {};
  var bkStatus = '', bkName = '';
  ...
  function render() {
    ...
    renderKpis(); renderDash(); renderBookings(); renderAvail(); renderBiz(); renderBadges();
  }
  ...
  function showPanel(name) {
    ...
    var titleKey = { dashboard: 'navDash', bookings: 'navBookings', availability: 'navAvail', businesses: 'navBiz' }[name];
